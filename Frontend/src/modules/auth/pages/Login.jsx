...
export default function UnifiedOTPFastLogin() {
  ...
  const primaryColor = "#CA2835" // Classic Red
    ...
    <div className="min-h-[100dvh] bg-white dark:bg-[#0a0a0a] flex flex-col relative overflow-hidden font-['Poppins']">
        ...
        <svg viewBox="0 0 1440 320" className="w-full h-full block" preserveAspectRatio="none" overflow="visible">
          <defs>
            <linearGradient id="topRedGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#CA2835" />
              <stop offset="100%" stopColor="#A81F2B" />
            </linearGradient>
          </defs>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-13 pb-40 relative z-10 overflow-y-auto">
        <div className={`w-full max-w-sm flex flex-col my-auto ${step === 2 ? "relative -top-8" : ""}`}>
          ...
          <div className="mb-5 mt-8 text-center flex flex-col items-center">
            <img
              src="/appzeto_food_logo_transparent.png"
              alt="Appzeto Food Logo"
              className="h-12 mt-0 mb-2 object-contain drop-shadow-md"
            />
              ...
              {step === 1 ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="p-1.5 ml-1 bg-gradient-to-r from-[#CA2835] to-[#A81F2B] hover:from-[#B02330] hover:to-[#8A1820] rounded-[10px] text-white shadow-md shadow-[#CA2835]/20 transition-all hover:scale-105 active:scale-95"
              ...
              {step === 1 ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-gradient-to-r from-[#CA2835] to-[#A81F2B] hover:from-[#B02330] hover:to-[#8A1820] disabled:opacity-50 text-white rounded-full font-medium text-base shadow-[0_8px_20px_rgba(184,11,61,0.3)] disabled:shadow-none transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                  >
                    {loading ? (
                ...
                >
                  ...
                  <div className="flex justify-between gap-3">
                    {[0, 1, 2, 3].map((index) => (
                      <input
                        ...
                        className={`w-14 h-14 sm:w-16 sm:h-16 text-center text-2xl font-bold bg-gray-50 dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 shadow-sm rounded-[20px] outline-none transition-all duration-300 text-gray-900 dark:text-white focus:bg-white dark:focus:bg-gray-900 focus:border-[#CA2835] focus:ring-4 focus:ring-[#CA2835]/10 hover:border-gray-400 ${blockTimer > 0 ? "opacity-50 cursor-not-allowed border-red-400 bg-red-50 text-red-800" : ""
                          }`}
                        placeholder="•"
                      />
                    ))}
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-gradient-to-r from-[#CA2835] to-[#A81F2B] hover:from-[#B02330] hover:to-[#8A1820] disabled:opacity-50 text-white rounded-full font-medium text-base shadow-[0_8px_20px_rgba(184,11,61,0.3)] disabled:shadow-none transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-4"
                  >
                    {loading ? (
                  ...
                  {blockTimer > 0 && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center w-fit mx-auto px-6 py-2.5 bg-red-50 dark:bg-red-950/20 rounded-xl border border-red-100 dark:border-red-900/50 mt-4">
                      <p className="text-[11px] font-bold text-[#CA2835] uppercase tracking-wider">
                        Too many failed attempts
                      </p>
                      <p className="text-sm font-bold text-[#CA2835]">
          ...
          {step === 1 && blockTimer <= 0 && (
            <div className="mt-5 flex justify-center w-full">
              <button
                ...
                className="flex items-center justify-center gap-1.5 px-8 py-[7.5px] bg-gradient-to-r from-[#CA2835] to-[#A81F2B] hover:from-[#B02330] hover:to-[#8A1820] text-white rounded-full shadow-[0_4px_14px_rgba(184,11,61,0.3)] hover:shadow-[0_6px_20px_rgba(184,11,61,0.45)] transition-all duration-200 active:scale-95 cursor-pointer group"
              >
          ...
          {step === 1 && (
            <div className="mt-8 text-center">
              <p className="text-[11px] text-gray-400/80 font-medium leading-relaxed max-w-[320px] mx-auto">
                ...
                <Link to="/user/profile/terms" state={{ from: "/user/auth/login" }} className="text-gray-400 hover:text-[#CA2835] transition-colors uppercase tracking-wider font-semibold">TERMS</Link>
                <span className="mx-2 text-gray-400/80 font-bold">•</span>
                <Link to="/user/profile/privacy" state={{ from: "/user/auth/login" }} className="text-gray-400 hover:text-[#CA2835] transition-colors uppercase tracking-wider font-semibold">PRIVACY</Link>
                <span className="mx-2 text-gray-400/80 font-bold">•</span>
                <Link to="/user/profile/support-info" state={{ from: "/user/auth/login" }} className="text-gray-400 hover:text-[#CA2835] transition-colors uppercase tracking-wider font-semibold">SUPPORT</Link>
              </p>
            </div>
          )}
      ...
      >
        ...
        >
          <div className="bg-gradient-to-br from-[#CA2835] to-[#A81F2B] p-8 text-center relative">
            <button
              onClick={handleEditNumber}
          ...
          <form onSubmit={handleNameSubmit} className="p-8 pt-6 space-y-6">
            <div className="space-y-4">
              ...
              <div className="relative group">
                <Input
                  ...
                  className="pl-4 h-14 bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-[#CA2835] transition-all group-hover:border-[#CA2835]/30"
                  autoFocus
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              <Button
                ...
                className="w-full h-14 bg-gradient-to-r from-[#CA2835] to-[#A81F2B] hover:from-[#B02330] hover:to-[#8A1820] text-white rounded-2xl font-bold text-lg shadow-lg shadow-[#CA2835]/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                {isUpdatingName ? (
        ...
        {showRestorePopup && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="w-20 h-20 bg-[#CA2835]/10 rounded-full flex items-center justify-center mx-auto mb-6">
                <Phone className="h-10 w-10 text-[#CA2835]" />
              </div>
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="w-full h-14 bg-[#CA2835] hover:bg-[#A81F2B] text-white font-bold rounded-2xl shadow-xl shadow-[#CA2835]/20 transition-all active:scale-[0.98]"
                >
                  Restore My Account
                </button>
                <button
